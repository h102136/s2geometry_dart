...
List<double> faceXYZToUV(int face, List<double> xyz) {
  ...
  switch (face) {
    ...
    case 5:
      ...
      break;
    default:
      throw ArgumentError('Invalid face'); // if the face is invalid (not 0-5)
  }
...
List<dynamic> xyzToFaceUV(List<double> xyz) {
  int face =
      largestAbsComponent(xyz); // determine which face that xyz projects to.
...
List<double> faceUVToXYZ(int face, List<double> uv) {
  ...
  switch (face) {
    ...
    case 5:
      return [v, u, -1];
    default:
      throw ArgumentError('Invalid face');
  }
}
